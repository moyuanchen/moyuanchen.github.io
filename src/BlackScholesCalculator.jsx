      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">Time to Expiry (years): {timeToExpiry}</label>
              <Slider 
                value={[timeToExpiry]}
                min={0.1}
                max={2}
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Option Price vs Spot Price</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={chartData}>
                      ...
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="price" stroke="#8884d8" name="Option Price" />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Greeks vs Spot Price</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={chartData}>
                      ...
                      <Line type="monotone" dataKey="rho" stroke="#ff0000" name="Rho" />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
